...
export class BadRequestError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.BAD_REQUEST_MSG);
...
export class ForbiddenError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.FORBIDDEN_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export class ConflictError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.CONFLICT_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export class DatabaseError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.DATABASE_ERROR_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export class InternalServerError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.INTERNAL_SERVER_ERROR_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export class NotFoundError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.NOT_FOUND_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
...
export class UnauthorizedError extends Error {
  ...
  constructor(message?: string) {
    super(message || ResponseConstants.UNAUTHORIZED_MSG);
    this.name = this.constructor.name;
    Error.captureStackTrace(this, this.constructor);
  }
}
